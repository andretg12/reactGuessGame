...
class Game extends React.Component {
    ...
    onSubmitClick = (event) => {
        ...
        if (userInput === answer) {
            let currentStandardScore = this.state.standardScore === null ? 0 : this.state.standardScore;
        ...
        if (this.state.gameAct < 2) {
            return (
                <div>
                    ...
                    <Form getFormValue={this.getFormValue} onSubmitClick={this.onSubmitClick} />
                    <p>{this.state.guessCount.join(', ')}</p>
                </div>
            );
        } else {
            return (
                <div className="tada">
                    ...
                    <p className="what">Your guesses were these:{this.state.guessCount.join(', ')}</p>
                </div>
            )
        }
